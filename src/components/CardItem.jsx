    ...
    return (
        <div className="section" style={{display: 'grid', gap:'0.4rem'}}>
            ...
            <div style={{display: 'flex', gap: '0.5rem', flexwrap: 'wrap'}}>
                <span style={{border: '1px solid var(--border)', borderRadius: 10, padding: '0.2rem 0.5rem'}}>GLove: {card.gloveSize || '-'}</span>
                <span style={{border: '1px solid var(--border)', borderRadius: 10, padding: '0.2rem 0.5rem'}}>Instruments: { card.instruments?.length ?? 0}</span>
                <span style={{border: '1px solid var(--border)', borderRadius: 10, padding: '0.2rem 0.5rem'}}>Sutures: {card.sutures?.length ?? 0}</span>
            </div>
